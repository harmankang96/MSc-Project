        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">All Lecturers</h1>
                    <div class="mb-4 text-right"><a href="addLecturer.php"><button class="btn btn-primary profile-button" type="button" data-toggle="tooltip" data-placement="top"> Add Lecturer </button></a></div>

                    <?php
                    if(!empty($_GET['delete'])){
                      $id=$_GET['delete'];
                      $del="delete from allLecturers where ID=$id";
                    ...
                    <?php
                     ...
                     <tr>
                      ...
                      <td> 
                       ...
                       <a href="editLecturer.php?id=<?php echo $row['ID']; ?>"><li class="list-inline-item">
                   ...
                   <?php } ?>
                     ...
                     <a href="login_form_student.php"><button class="btn btn-primary profile-button" type="button" data-toggle="tooltip" data-placement="top"> Student Dashboard </button></a>
